              ...
              <div className="about__one-left">
                <div className="about__one-left-title">
                  ...
                  <h2 className="wow fadeInRight" data-wow-delay=".6s">
                    Innovative Solutions for Every Infrastructure Challenge
                  </h2>
                </div>
                <div className="row al-center mt-45">
                  <div className="col-md-4 md-mb-25">
                    <div
                      ...
                      data-wow-delay=".4s"
                    >
                      <img className="md_img_full" src={aboutOne} alt="image" />
                    ...
                    <div className="about__one-left-list">
                      ...
                      >
                        ...
                        <div className="about__one-left-list-item-content">
                          ...
                          <p>
                            Advanced construction technologies and digital tools
                            streamline our processes, allowing our teams to
                            deliver projects with greater accuracy and
                            efficiency.
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div className="about__one-left-list-item-content">
                          ...
                          <p>
                            Our skilled engineers bring deep industry knowledge
                            and hands-on expertise, enabling them to handle
                            complex challenges from planning to execution.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="wow fadeInDown" data-wow-delay="1.2s">
                      <Link className="build_button mt-40" to="about">
